        ...
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#" className="hover:text-cyan-400 transition-colors">Vista Academy</a></li>
              <li><a href="#" className="hover:text-cyan-400 transition-colors">Prop Challenge</a></li>
              <li><a href="#" className="hover:text-cyan-400 transition-colors">Algo Trading</a></li>
              <li><a href="#" className="hover:text-cyan-400 transition-colors">VIP Membership</a></li>
            </ul>
          </div>
