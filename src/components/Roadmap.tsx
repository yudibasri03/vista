export default function Roadmap() {
  const tradersJourney = [
    {
      ...
      text:
        "Belajar di Vista Academy dan temukan metode trading milik kamu sendiri.",
    ...
    },
    {
      ...
      text:
        "Uji metode tradingmu, bangun disiplin, dan percaya strategi adalah metode terbaik.",
    ...
    },
    {
      ...
      text:
        "Menjadi trader profesional dan memiliki portofolio yang terukur.",
  ...
  const investorsJourney = [
    {
      ...
      text:
        "Petakan arah diversifikasimu sebagai investor yang cerdas.",
    ...
    },
    {
      ...
      text:
        "Mulai dari VIP Group Signal, lanjutkan diversifikasi melalui Algo ATM.",
    ...
    },
    {
      ...
      text:
        "Menjadi smart investor dengan portofolio diversifikasi dari team trader dan algo trading.",
  ...
  const HorizontalTimeline = ({ journey, label, isTraders }) => (
    <div className="mb-24">
      {/* Label di atas agar tidak nabrak garis */}
      <div className="mb-6 text-left pl-28">
      ...
      <div className="relative flex items-center px-10">
        {/* GARIS */}
        <div
          className={`absolute top-1/2 left-10 right-10 h-1 -translate-y-1/2 rounded-full ${
            isTraders
        ...
        <div className="w-full flex justify-between relative z-10">
          {journey.map((checkpoint) => (
            ...
            >
              {/* TITLE + TEXT */}
              <div className="mb-10 h-20 flex flex-col justify-end">
              ...
              {/* DOT */}
              <div
                className={`w-6 h-6 ${checkpoint.dotColor} rounded-full shadow-lg ${checkpoint.dotShadow} ring-4 ring-slate-950`}
              />
